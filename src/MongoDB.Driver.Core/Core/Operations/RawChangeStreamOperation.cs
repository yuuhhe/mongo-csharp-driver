...
namespace MongoDB.Driver.Core.Operations
{
    ...
    /// </summary>
    public interface IRawChangeStreamOperation : IReadOperation<IChangeStreamCursor<RawBsonArray>>
    {
        // properties
        /// <summary>
        ...
        IAsyncCursor<RawBsonArray> Resume(IReadBinding binding, CancellationToken cancellationToken);
        ...
        Task<IAsyncCursor<RawBsonArray>> ResumeAsync(IReadBinding binding, CancellationToken cancellationToken);
    }

    /// <summary>
    /// A change stream operation.
    /// </summary>
    public class RawChangeStreamOperation : IRawChangeStreamOperation
    {
        // private fields
        ...
        public RawChangeStreamOperation(
            ...
            IBsonSerializer<RawBsonArray> resultSerializer,
        ...
        // public methods
        /// <inheritdoc />
        public IChangeStreamCursor<RawBsonArray> Execute(IReadBinding binding, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        public async Task<IChangeStreamCursor<RawBsonArray>> ExecuteAsync(IReadBinding binding, CancellationToken cancellationToken)
        {
            Ensure.IsNotNull(binding, nameof(binding));
            var bindingHandle = binding as IReadBindingHandle;
            if (bindingHandle == null)
        ...
        /// <inheritdoc />
        public IAsyncCursor<RawBsonArray> Resume(IReadBinding binding, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        public async Task<IAsyncCursor<RawBsonArray>> ResumeAsync(IReadBinding binding, CancellationToken cancellationToken)
        {
